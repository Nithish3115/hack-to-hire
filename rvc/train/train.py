...
def run(
    ...
    # Validations - Modified for debugging
    ...
    if len(train_loader) < 3:
        print(
            f"WARNING: Only {len(train_loader)} batches available (minimum 3 recommended)"
        )
        print("Proceeding with training anyway for debugging...")
        # Comment out the exit to proceed with training
        # os._exit(2333333)
